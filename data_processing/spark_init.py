...
class Sparkinit():
    ...
    def __init__(self,  processadores:str = cpu_cores, memoria:str = memoria_gb) -> None:
        ...
        self.spark = SparkSession.builder \
            ...
            .config("spark.jars.packages",
                    ...
                    "org.apache.spark:jspark-core_2.12-3.4.0,org.apache.hadoop:hadoop-common-3.3.6.jar,") \
